        ...
        <div className="auth-card">
          ...
          <form>
            ...
            <div className="auth-links">
              <span>New? <Link to="/register">Register now</Link></span>
              <a href="" role="button" id="forgot-password-btn">Forgot password?</a>
            </div>

            <button type="submit" data-mdb-button-init data-mdb-ripple-init className="btn btn-primary btn-lg btn-block" id="login-btn">Sign In</button>
          </form>
        </div>
      </div>
